...
public class ProcedimentoRapidoController {
    ...
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> criar(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(new ApiResponse<>(true, "Procedimento rápido criado com sucesso", resultado));
    ...
    @GetMapping
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<List<ProcedimentoRapidoListDTO>>> listar(
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dataInicio,
            @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dataFim,
            @RequestParam(required = false) StatusProcedimento status
    ) {
        log.info("Listando procedimentos - Filtros: dataInicio={}, dataFim={}, status={}", dataInicio, dataFim, status);
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimentos listados com sucesso", procedimentos)
            );
        } catch (Exception e) {
            log.error("Erro ao listar procedimentos: {}", e.getMessage(), e);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                    .body(new ApiResponse<>(false, "Erro ao listar procedimentos", null));
        }
    }
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<List<ProcedimentoRapidoListDTO>>> listarAguardando() {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimentos aguardando listados com sucesso", procedimentos)
            );
        } catch (Exception e) {
            log.error("Erro ao listar procedimentos aguardando: {}", e.getMessage(), e);
            return ResponseEntity.ok(new ApiResponse<>(true, "Procedimentos listados", List.of()));
        }
    }
    ...
    @GetMapping("/urgentes")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<List<ProcedimentoRapidoListDTO>>> listarUrgentes() {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimentos urgentes listados com sucesso", procedimentos)
            );
        } catch (Exception e) {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> buscarPorId(@PathVariable Long id) {
        log.info("Buscando procedimento ID: {}", id);
        try {
            ProcedimentoRapidoDTO procedimento = procedimentoService.buscarPorId(id);
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimento encontrado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> atualizarStatus(
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Status atualizado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> iniciarAtendimento(
            @PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Atendimento iniciado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> adicionarAtividade(
            @PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(new ApiResponse<>(true, "Atividade adicionada com sucesso", procedimento));
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
        } catch (BusinessException e) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> executarAtividade(
            @PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Atividade executada com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> aprazarAtividade(
            @PathVariable Long id,
            @PathVariable Long atividadeId,
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Atividade aprazada com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> registrarDesfecho(
            @PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Desfecho registrado e procedimento finalizado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> cancelar(
            @PathVariable Long id,
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimento cancelado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> desbloquear(
            @PathVariable Long id,
            @RequestParam Long operadorId
    ) {
        ...
        try {
            ...
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Procedimento desbloqueado com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> obterHistorico(@PathVariable Long id) {
        log.info("Obtendo histórico do procedimento ID: {}", id);
        try {
            ProcedimentoRapidoDTO procedimento = procedimentoService.obterHistorico(id);
            return ResponseEntity.ok(
                    new ApiResponse<>(true, "Histórico obtido com sucesso", procedimento)
            );
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<ProcedimentoRapidoDTO>> encaminharDeAtendimento(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(new ApiResponse<>(true, "Paciente encaminhado para Cuidados de Enfermagem com sucesso", procedimento));
        } catch (ResourceNotFoundException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(new ApiResponse<>(false, e.getMessage(), null));
        } catch (BusinessException e) {
